    ...
    this.note.getUserNote().subscribe(
      (response: any[]) => {
        ...
        for (let t = 0; t < response.length; t++) {
          ...
          q.usr_ans1 = response[t]['user answer'][0];
          q.usr_ans2 = response[t]['user answer'][1];
          oneNote.question = q;
          oneNote.answer = new Answer();
          oneNote.answer.answer1 = response[t]['correct answer'][0];
          oneNote.answer.answer2 = response[t]['correct answer'][1];
